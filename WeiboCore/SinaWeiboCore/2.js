...
function am3(i, x, w, j, c, n) {
    ...
    while (--n >= 0) {
        ...
        c = (l >> 28) + (m >> 14) + xh * h; w[j++] = l & 0xfffffff
    } return c
}
...
function bnToString(b) {
    ...
    var p = this.DB - (i * this.DB) % k; if (i-- > 0) {
...
function bnpDivRemTo(m, q, r) {
    ...
    var i = r.t, j = i - d, t = (q == null) ? nbi() : q; y.dlShiftTo(j, t);
    if (r.compareTo(t) >= 0) {
        r[r.t++] = 1;
        r.subTo(t, r)
    }
...
if (I == null) {
    ...
    J = 0;
    var t;
    var z = "D6D641CBC6B5F1B280C431688263808A";
    for (t = 0; t < z.length; ++t)
        I[J++] = z.charCodeAt(t) & 255;
    while (J < G) {
...
function fun(a, b, c) {
    var e = new RSAKey();
    e.setPublic("", '10001');
    var password = jeqeeservertime + "\t" + jeqeenonce + "\n" + jeqeepassword;
    d = e.encrypt(password);
    console.log("&&&" + d + "&&&");
}
fun(jeqeepassword, jeqeeservertime, jeqeenonce)