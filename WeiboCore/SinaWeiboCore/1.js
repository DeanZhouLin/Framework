...
function fun(a) {
    ...
    var e = new RSAKey();
    e.setPublic("", '10001');
    //var password = jeqeeservertime + "\t" + jeqeenonce + "\n" + jeqeepassword;
    d = e.encrypt(jeqeepassword);
    console.log("&&&" + d + "&&&");
}
fun(jeqeepassword)