...
{
    [TestClass]
    public class TestComHttpWorkInterface
    {
        ...
        private const PlatformType CurrPlatformType = PlatformType.Com;
        ...
        {
            var res = CurrPlatformType.GetHttpWork().GetUserEntity(CurrWebLogin, "1454461772");
            Console.WriteLine(res);
        }//获取用户主页的信息
    }
}
