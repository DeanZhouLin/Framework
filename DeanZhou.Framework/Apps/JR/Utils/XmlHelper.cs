...
namespace JFx.Utils
{
    ...
    public class XmlHelper
    {
        ...
        public static XmlNode GetXmlNodeByAttribute(string fileName, string xpath, string attrName, string attrValue)
        {
            ...
            foreach (XmlNode temp in list)
            {
                ...
                if (temp.Attributes[attrName] != null && temp.Attributes[attrName].Value.Equals(tempAttrValue, StringComparison.OrdinalIgnoreCase))
                {
                    result = temp;
                    break;
                }
        ...
        /// <returns>获取到的节点</returns>
        public static XmlNode GetTreeXmlNodeByAttribute(XmlNodeList list, string attrName, string attrValue)
        {
            XmlNode result = null;
            foreach (XmlNode temp in list)
            {
                if (temp.Attributes[attrName] != null && temp.Attributes[attrName].Value == attrValue)
                {
                    result = temp;
                    break;
                }
                ...
                {
                    GetTreeXmlNodeByAttribute(temp.ChildNodes, attrName, attrValue);
                }
            }
            return result;
        }
